...
async function mostrarReceta() {
    ...
    recipesName.style.fontSize = "18px";
    ...
    imgRecipes.style = "width:100px; height:100px; objectFit = cover; objectPosition: center";
...
buscar.id = "busqueda";
buscar.style = "width: 21%; height: 3rem; border-radius: 1rem; padding: 1rem; font-weight: 400; border: solid #ee974bc2";
buscar.placeholder = "example: Onion...";

const boton = document.createElement('button');
boton.textContent = "Buscar Recetas";
boton.onclick = mostrarReceta;
boton.style = "font-size: 1.2rem; width: 10%; height: 3rem; margin: 2rem; border: none; border-radius: 1.2rem; background-color:#ee974bc2; font-weight: bolder;";

const limpiar = document.createElement('button');
limpiar.textContent = "Limpiar";
limpiar.id = "Limpiar";
limpiar.onclick = limpiarCampo;
limpiar.style = "font-size: 1.2rem; width: 8%; height: 3rem; border: none; border-radius: 1.2rem; background-color:#ee974bc2; font-weight: bolder;";
